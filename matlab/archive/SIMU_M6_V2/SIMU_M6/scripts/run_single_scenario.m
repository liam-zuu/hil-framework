function res = run_single_scenario(ctrl_type, traj_type, params, seed)
...
%   seed       [scalar, optional] random seed for reproducibility
% Output:
...
%     .mean_slip_ratio— mean |slip_ratio| when slip detected
    ...
    % Set random seed if provided (for multi-trial reproducibility)
